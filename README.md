...
|---|---|---|
| **Smile Island**<br><sub>[Live](https://app.votechx.com) · private repo</sub> | Multi-workspace clinic-management SaaS for Egyptian dental clinics: reception, patients, doctors, finance, stock, and HR in one Arabic-RTL workspace. | <img src="https://skillicons.dev/icons?i=nextjs,nestjs,ts,prisma,postgres,docker,githubactions&perline=7" height="26" alt="Next.js, NestJS, TypeScript, Prisma, PostgreSQL, Docker, GitHub Actions"><br><sub>Next.js · NestJS · Prisma · PostgreSQL · Docker · GitHub Actions</sub> |
| **Clinic Assistant**<br><sub>[Live](https://chatbot.votechx.com) · private repo</sub> | AI reservation assistant for clinics on WhatsApp and web, with an operator console for the clinic's staff. | <img src="https://skillicons.dev/icons?i=nestjs,react,ts,postgres,docker&perline=5" height="26" alt="NestJS, React, TypeScript, PostgreSQL, Docker"><br><sub>NestJS · React · PostgreSQL + pgvector · WhatsApp API</sub> |
| **si-reach**<br><sub>Private repo · feeds the Smile Island trial funnel</sub> | Multi-tenant B2B lead-generation and outreach CRM: scrapes Google Maps across Egypt's 27 governorates, scores leads, sends Arabic WhatsApp outreach, answers replies with an AI agent, and escalates to a human. | <img src="https://skillicons.dev/icons?i=fastapi,py,postgres,react,docker&perline=5" height="26" alt="FastAPI, Python, PostgreSQL, React, Docker"><br><sub>FastAPI · n8n · PostgreSQL · React · LLM classification and routing</sub> |
| **Inventory**<br><sub>Private repos (backend + mobile)</sub> | Warehouse management for several independent inventories. Workers file daily stock and cash reports from an offline-first Arabic-RTL mobile app; the API derives sales, shortfall, and balance for an administrator to approve. | <img src="https://skillicons.dev/icons?i=nestjs,prisma,postgres,flutter,dart&perline=5" height="26" alt="NestJS, Prisma, PostgreSQL, Flutter, Dart"><br><sub>NestJS · Prisma · PostgreSQL · Flutter</sub> |
| **SIS platform**<br><sub>In build (verified skeleton, Sep 2026) · private repo</sub> | Student information system for Egyptian public universities: one deployment serving sixteen faculties by configuration, twenty applications specified rule by rule before any code. | <img src="https://skillicons.dev/icons?i=dotnet,cs,docker,githubactions&perline=4" height="26" alt=".NET, C#, Docker, GitHub Actions"><br><sub>ASP.NET Core · SQL Server · modular monolith</sub> |
| **VOTECHX website**<br><sub>[Live](https://votechx.com) · private repo</sub> | The bilingual company site, statically built, English at the root and Arabic under `/ar/`. | <img src="https://skillicons.dev/icons?i=astro,ts,html,css,nginx&perline=5" height="26" alt="Astro, TypeScript, HTML, CSS, nginx"><br><sub>Astro · static output · nginx</sub> |

## Founder work at VINEX

| Project | What it does | Stack |
|---|---|---|
| **Abaad ERP**<br><sub>v6.0.0 · private</sub> | Self-hosted ERP for 3D-printing shops: quote-to-delivery orders with per-gram pricing and PDFs, filament inventory, printer depreciation and wear, expenses, and a live finance dashboard. | <img src="https://skillicons.dev/icons?i=py,fastapi,sqlite,react,ts,vite,tailwind&perline=7" height="26" alt="Python, FastAPI, SQLite, React, TypeScript, Vite, Tailwind"><br><sub>Python · FastAPI · SQLite (WAL) · React · Vite · shadcn/ui</sub> |
| **Abaad Platform**<br><sub>Private</sub> | Public website and ordering platform for Abaad. The quoted price is the maximum the customer pays, enforced by a versioned pricing function and database check constraints rather than by policy. | <img src="https://skillicons.dev/icons?i=nextjs,ts,py,docker&perline=4" height="26" alt="Next.js, TypeScript, Python, Docker"><br><sub>Next.js 15 · Drizzle · Python slicing worker · Caddy</sub> |
| **EWIMS**<br><sub>Pilot v0.4.0 · private</sub> | Encrypted, offline-first workforce insurance records for a controlled three-PC Windows pilot: per-device SQLCipher stores, one-use provisioning, authenticated HTTPS sync, no public cloud. | <img src="https://skillicons.dev/icons?i=py,sqlite,windows&perline=3" height="26" alt="Python, SQLite, Windows"><br><sub>Python · SQLCipher · Windows</sub> |
| **cardscan**<br><sub>In build · private</sub> | Captures business cards at trade fairs, extracts and verifies the contact details, and stores them in a CRM that keeps working when the hall has no signal. | <img src="https://skillicons.dev/icons?i=kotlin,androidstudio,ts,nodejs&perline=4" height="26" alt="Kotlin, Android Studio, TypeScript, Node.js"><br><sub>Kotlin · TypeScript · shared contact schema</sub> |
| **Monion**<br><sub>Private</sub> | Offline-first university bus platform: driver identity, passenger attendance, live fleet operations, device qualification, and safety monitoring. | <img src="https://skillicons.dev/icons?i=flutter,dart,nestjs,prisma,react,postgres,docker&perline=7" height="26" alt="Flutter, Dart, NestJS, Prisma, React, PostgreSQL, Docker"><br><sub>Flutter · NestJS · Prisma · React · PostgreSQL · MinIO</sub> |
| **ORIVEX**<br><sub>Design stage · [public docs](https://github.com/AbdelRahman-Madboly/PharmBot-docs)</sub> | Pharmacy operations product. Domain rules, safety classification, and data contracts are written and tested; the application layer is still planned. | <img src="https://skillicons.dev/icons?i=nodejs,prisma,md&perline=3" height="26" alt="Node.js, Prisma, Markdown"><br><sub>Node.js · Prisma · documented decisions</sub> |

## Research

| Project | Question | Stack |
|---|---|---|
| **WaveGate**<br><sub>Reproducible baseline committed · results not yet published</sub> | Can a wavelet boundary gate, trained on real faces only with self-blended pseudo-fakes, generalise deepfake detection to manipulation methods it has never seen? | <img src="https://skillicons.dev/icons?i=pytorch,py&perline=2" height="26" alt="PyTorch, Python"><br><sub>PyTorch · EfficientNet-B5 · 2-level DWT · optional temporal state-space head</sub> |
| **AraFT**<br><sub>In progress · targeting a Q1 journal</sub> | How much of an LLM's Arabic weakness is tokenizer fertility, and how much is data? A compute-matched, byte-matched, dose-controlled intervention study. | <img src="https://skillicons.dev/icons?i=pytorch,py,bash&perline=3" height="26" alt="PyTorch, Python, Bash"><br><sub>PyTorch · Hugging Face · Qwen 3.5 substrates</sub> |
| **USV link manager**<br><sub>97% held-out test accuracy · private</sub> | Which link should a maritime robot use right now: cellular, satellite, both, or store and forward? A mission-aware classifier with a physics-based safety guard. | <img src="https://skillicons.dev/icons?i=py&perline=1" height="26" alt="Python"><br><sub>Pure-NumPy MLP · early stopping · guarded inference</sub> |

## Edge and IoT

| Project | What it does | Stack |
|---|---|---|
| **FarmLens**<br><sub>[node](https://github.com/AbdelRahman-Madboly/FarmLens-node) · [app](https://github.com/AbdelRahman-Madboly/FarmLens-app)</sub> | Solar-powered edge-AI field node for crop health: camera-based disease detection fused with soil sensor readings into one risk score, plus a Flutter companion app. Software validated end to end against a mock node; field hardware not yet built. | <img src="https://skillicons.dev/icons?i=raspberrypi,fastapi,py,cpp,flutter&perline=5" height="26" alt="Raspberry Pi, FastAPI, Python, C++, Flutter"><br><sub>Raspberry Pi · FastAPI · YOLOv11n INT8 · ESP32 · Flutter</sub> |
| **Nazer**<br><sub>Private</sub> | Vehicle-mounted box that detects speeding violations and reports them to a cloud backend, with a driver app and an admin site. | <img src="https://skillicons.dev/icons?i=cpp,fastapi,py,flutter,react&perline=5" height="26" alt="C++, FastAPI, Python, Flutter, React"><br><sub>ESP32 · GPS + IMU · C++ · FastAPI · Flutter · React</sub> |
